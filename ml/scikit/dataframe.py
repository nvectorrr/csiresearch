...
def load_dataframe_reduced():
    ...
    train['category'] = train['category'].replace(['air'], 0)
    train['category'] = train['category'].replace(['metal'], 1)
    test['category'] = test['category'].replace(['air'], 0)
    test['category'] = test['category'].replace(['metal'], 1)
